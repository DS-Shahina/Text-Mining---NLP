...
# It counts word index location in the sentence
...
last_word = words[-1] # or you can do this type also

concat_word = first_word + last_word # join 2 words
print(concat_word)

#concat_word = first_word + " " + last_word - space between 2 words
...
words = word_tokenize("I am reading NLP Fundamentals") # we can use split also
print(words)
...
stop_words = stopwords.words('English') # 179 pre defined stop words, in R 174 
print(stop_words)
...
from autocorrect import Speller # Library to check typos - pip install autocorrect
...
# it's find POS - Parts of Speech -NE- Name Entity
