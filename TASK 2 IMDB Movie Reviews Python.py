...
for i in range(1,15):
  ip=[]  
  url1="https://www.imdb.com/title/tt6077448/reviews?ref_=tt_urv"+str(i)
...
with open("idbm.txt","w",encoding='utf8') as output:
    output.write(str(imdb_reviews))
#350 reviews extracted
...
stop_words.extend(["game","emotion","sacred","acting","watching","quality"])
...
customised_words = ['series', 'season'] # If you want to remove any particular word form text which does not contribute much in meaning
