...
inspect(x[1]) # if you want to see what is this words
...
x1 <- tm_map(x1, removeWords, c('phone','oneplus','also')) # remove very popular terms and those which is not required
...
stopwdrds <-  readLines(file.choose()) # 572 stop words
